...
public class QRCodeUtil {
     ...
     */
    public static void encode(String charSet,String content,int qrWidth,int qrHeight,String formatName,String imgPath) throws IOException {
        BufferedImage image = QRCodeUtil.createImage(charSet,content,qrWidth,qrHeight);
        insertLogoImage(image,ImageIO.read(new File("C:\\Users\\陈毅宸\\Desktop\\my.png")),150,150);
        try {
    ...
    public static void main(String[] args) throws IOException {
        encode("UTF-8","https://www.bilibili.com/video/BV16W411P7ni?t=0.8",400,400,"jpg","C:\\Users\\陈毅宸\\Desktop\\first.jpg");
    }
